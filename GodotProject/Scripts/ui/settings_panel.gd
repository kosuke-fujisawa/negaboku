...
# UI要素への参照
@onready
var master_volume_slider: HSlider = $SettingsDialog/VBoxContainer/MasterVolumeContainer/MasterVolumeSlider
@onready
var master_volume_value: Label = $SettingsDialog/VBoxContainer/MasterVolumeContainer/MasterVolumeValue
@onready
var bgm_volume_slider: HSlider = $SettingsDialog/VBoxContainer/BGMVolumeContainer/BGMVolumeSlider
@onready
var bgm_volume_value: Label = $SettingsDialog/VBoxContainer/BGMVolumeContainer/BGMVolumeValue
@onready
var sfx_volume_slider: HSlider = $SettingsDialog/VBoxContainer/SFXVolumeContainer/SFXVolumeSlider
@onready
var sfx_volume_value: Label = $SettingsDialog/VBoxContainer/SFXVolumeContainer/SFXVolumeValue
@onready
var fullscreen_check: CheckBox = $SettingsDialog/VBoxContainer/FullscreenContainer/FullscreenCheck
@onready
var resolution_option: OptionButton = $SettingsDialog/VBoxContainer/ResolutionContainer/ResolutionOption
