...
func initialize_battle(battle_sys: BattleSystem, rel_sys: RelationshipSystem, party: Array[Character], enemy_list: Array[Character]):
...
func _on_attack_pressed():
	...
	var action = BattleSystem.BattleAction.new(BattleSystem.ActionType.ATTACK)
...
func _on_skill_pressed():
	...
	var action = BattleSystem.BattleAction.new(BattleSystem.ActionType.SKILL)
...
func _on_defend_pressed():
	...
	var action = BattleSystem.BattleAction.new(BattleSystem.ActionType.DEFEND)
	battle_system.perform_action(current_turn_character, action)
	$UI/BattleInterface/ActionPanel.visible = false

func get_first_alive_enemy() -> Character:
