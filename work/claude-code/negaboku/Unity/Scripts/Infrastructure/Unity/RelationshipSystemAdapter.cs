...
namespace NegabokuRPG.Infrastructure.Unity
{
    ...
    {
        private static RelationshipSystemAdapter instance;
        public static RelationshipSystemAdapter Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = FindObjectOfType<RelationshipSystemAdapter>();
                    if (instance == null)
                    {
                        var go = new GameObject("RelationshipSystemAdapter");
                        instance = go.AddComponent<RelationshipSystemAdapter>();
